...
public class NotificationRouter {
    ...
    public RouterFunction<ServerResponse> notificationRoutes() {
        return RouterFunctions.nest(
                path(AppConstants.EndPoints.NOTIFICATIONS_BASE_PATH),
    ...
    private Mono<ServerResponse> createNotification(ServerRequest request) {
        ServerRequest filteredRequest = HeaderFilterReactiveUtil.filterHeaders(request, filterBasic());
    ...
    private HashSet<String> filterBasic() {
        ...
        allowedHeaders.add(AppConstants.Headers.REQUEST_ID);
